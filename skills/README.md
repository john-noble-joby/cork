...
than the author's — agentic harness reviewers (`codex/…`, `claude/…`, `opencode/…`, `pi/…`) that
run read-only inside the scratch tree and can verify their claims, plus Copilot API models —
